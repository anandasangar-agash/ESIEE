...
;lire nombre suivant
    push ecx
    push entier
    call convertir_str_int; # à changer ,le nombre peut continuer sur le dèbut du tampon
...
tampon:
;Convention C
;Demande une saisie et vide l'entrèe standard
;dans le tampon.
;le dèbut du flot est à l'adresse *debut_flot+entree_tampon
;la fin du flot à l'adresse fin_flot (ègale à debut flot si flot est vide)
    push eax
    push ebx
    push ecx
    push edx
...
;*****************************************
sprint_int:
;convention C. ècrit en base 10 le nombre.(positif nègatif ou nul)
;renvoie le nombre de caractère ècrit
;arg1 nombre_a ecrire, arg2 place oè ècrire.
    push ebp
    mov ebp,esp
    push ebx
    mov eax,0
...
esprint_int:
;convention C.
;ècrit en base 10 le nombre positif strictement à ècrire.
;renvoie le nombre de caractère ècrit.
;arg1 nombre_a ecrire, arg2 place oè ècrire.
    push ebp
    mov ebp,esp
...
;arg1 endroit oè ècrire (4 byte), arg2 endroit oè lire
    push ebp
    mov ebp,esp
    push ebx ; adresse oè lire
